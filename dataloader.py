...
@Author: Wang Yang
@Date:   2024/12/15 20:52 
@Last Modified by: Wang Yang
@Descirption : Dataloader adjust to model
'''
...
from torch_geometric.typing import EdgeType, InputNodes, OptTensor, WITH_PYG_LIB, WITH_TORCH_CLUSTER
...
class DataLoader(NodeLoader):
    ...
    def collate_fn(self, index: Union[Tensor, List[int]]) -> Any:
        ...
        pos_rw, neg_rw = self.sample(index)
        return out, pos_rw, neg_rw
